...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (split.length != 2)
                    Toast.makeText(getApplicationContext(), "Please enter text in required format", Toast.LENGTH_SHORT).show();
                else
    ...
    private void fetchStores(String placeType, String businessName) {
        ...
        retrofit2.Call<PlacesPOJO.Root> call = apiService.doPlaces(placeType, latLngString, businessName, true, "distance", APIClient.GOOGLE_PLACE_API_KEY);
    ...
    private void fetchDistance(final PlacesPOJO.CustomA info) {
        ...
        retrofit2.Call<ResultDistanceMatrix> call = apiService.getDistance(APIClient.GOOGLE_PLACE_API_KEY, latLngString, info.geometry.locationA.lat + "," + info.geometry.locationA.lng);
